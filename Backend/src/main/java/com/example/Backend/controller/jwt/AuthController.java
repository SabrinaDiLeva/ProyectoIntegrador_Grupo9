...
import com.example.Backend.config.jwt.JwtProviderConfig;
import com.example.Backend.dto.command.JwtDTO;
...
public class AuthController {
     ...
     */
    @PostMapping("/token")
    public ResponseEntity<Map<String, Object>> token(@RequestBody UsuarioDTO user) {
        ...
        Authentication authentication = authenticationManager.authenticate
                (new UsernamePasswordAuthenticationToken(user.getEmail(), user.getContrasenia()));
        /*
